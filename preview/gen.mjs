...
<link rel="stylesheet" href="${A}/css/main.css?v=39">
${analyticsHead()}</head>
...
page('connect.html', {
  ...
  body: pageHead('Make an Impact', 'Talk with our founder before you give.', 'Serious support starts with a conversation, not a checkout page. Tell us how you want to help and we will set up time with our founder, Luke Erickson. See the plan, ask the hard questions, then decide where you fit.') +
