...
<link rel="stylesheet" href="${A}/css/main.css?v=30">
${analyticsHead()}</head>
...
<script src="${A}/js/main.js?v=30"></script>
...
const roles = [
  ...
  },
  {
    ...
    meta: 'Internship &middot; Ventura County',
    teaser: 'Learn how a startup accelerator runs from the inside. Interns support events, founder research, marketing, and operations, and leave with real experience and a network in Ventura County.',
    full: `${svJobAbout}<h4>About the role</h4><p>This is an early-stage internship built around what you want to learn and how you can help. Interns work alongside our team on events, founder research, marketing, and day-to-day operations, and leave with real, resume-ready experience and a network across Ventura County.</p><p>Apply below and tell us what you are studying, when you are available, and how you would like to contribute.</p>`,
  },
];
page('careers.html', {
  title: 'Careers',
