...
<link rel="stylesheet" href="${A}/css/main.css?v=13"></head>
...
<script src="${A}/js/main.js?v=13"></script>
</body></html>`;
...
const board = [
  ...
  { n: 'Sean Herwaldt', r: 'Board Member, Director at Curri · SpaceX alum', p: 'team/sean-herwaldt.jpg', pos: 'center 27%', zoom: 1.6, li: 'https://www.linkedin.com/in/seanherwaldt/',
