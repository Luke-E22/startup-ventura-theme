...
const newsPosts = [
    ...
    paras: [
      ...
      'Sean joins the board as a former SpaceX operator. In more than five years there he rose to global supply chain manager at one of the most demanding engineering companies in the world, the same company that made history this past June by completing the largest IPO ever. Behind a milestone like that stand years of operational discipline: keeping a rocket company supplied means solving hard problems under constant pressure and building the planning systems and supplier relationships that let ambitious teams actually ship. That is exactly the kind of operating experience early founders need in their corner.',
