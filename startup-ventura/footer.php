		...
		<div class="footer-grid">
			<div class="footer-brand">
				...
				<div class="footer-social">
					...
					<a href="<?php echo esc_url( SV_FACEBOOK ); ?>" aria-label="Facebook" rel="noopener" target="_blank">
						<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M22 12.06C22 6.5 17.52 2 12 2S2 6.5 2 12.06c0 5.02 3.66 9.18 8.44 9.94v-7.03H7.9v-2.9h2.54V9.85c0-2.5 1.49-3.89 3.77-3.89 1.09 0 2.23.2 2.23.2v2.46h-1.26c-1.24 0-1.63.77-1.63 1.56v1.88h2.78l-.44 2.9h-2.34V22c4.78-.76 8.44-4.92 8.44-9.94Z"/></svg>
					</a>
			...
			<div class="footer-col">
				...
				<?php else : ?>
					<ul>
						...
						<li class="footer-hiring"><a href="<?php echo esc_url( home_url( '/careers/' ) ); ?>"><?php esc_html_e( 'Join our team', 'startup-ventura' ); ?> <span class="sep">|</span> <?php esc_html_e( 'Careers', 'startup-ventura' ); ?></a></li>
